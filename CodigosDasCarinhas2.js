	...
	//---------------------------------------------------------------------- ChangeLanguage
	 $('.Language').click(function(){
		...
		if($(".LanguageList").length){
			...
			var html = "<div class='LanguageList'><ul><a href='es/"+page+"'><li class='spain'></li></a><a href='cn/"+page+"'><li class='china'></li></a></ul></div>";
			$("#page_header").append(html);
		}
		else{
			var html = "<div class='LanguageList'><ul><a href='es/"+page+"'><li class='spain'></li></a><a href='cn/"+page+"'><li class='china'></li></a></ul></div>";
			$("#page").append(html);
